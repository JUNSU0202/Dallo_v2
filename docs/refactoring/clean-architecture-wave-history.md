...
> 본 문서는 Dallo DevSecOps 프로젝트가 **Wave 2-A 부터 Wave 5-I-1 까지** 어떤 순서와 이유로 구조를 정리해 왔는지를 기록한다.
